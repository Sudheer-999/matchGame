...
import './index.css'
import TabItem from '../TabItems/index'
...
class MatchGame extends Component {
    ...
    return (
      <div className="game-over">
        <div className="game-over-con">
          ...
          <h1>{score}</h1>
          <button type="button" className="reset-btn" onClick={this.onResetBtn}>
            <img
  ...
  onThumbnailClick = id => {
    ...
    const randomListItem = imagesList[randomNum]

    const {randomList} = this.state

    const isMatched = randomList.id === id
    ...
    this.setState({randomList: randomListItem})
  }

  render() {
    const {score, time, randomList, isGameOver} = this.state

    const filteredList = this.getfilteredThumbnails()

    const randomImg = randomList.imageUrl
    ...
    return (
      <div className="bg-container">
          ...
          <li>
            <div className="score-time-con">
              ...
              <div className="time-con">
                ...
                />
                <p className="game-time">{time} sec</p>
              </div>
            </div>
          </li>
        </ul>
        {isGameOver === false && time > 0 && (
          <div className="game-on-con">
            <div className="random-image-con">
        ...
        <div className="sub-con">
          {(isGameOver || time === 0) && this.renderGameOver()}
        </div>
      </div>
    )
  }
